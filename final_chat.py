...
# Streamlit app
st.title("PDF Processor and Information Extractor with Chatbot")
    ...
    if st.button("Ask"):
        if st.session_state.context:
            try:
                ...
                st.error(f"Iam don't have knowledge about the query: {str(e)}")
        else:
...
st.write("Note: This app processes PDFs, translates from Spanish to English, extracts product information, and allows you to chat with the document using the Gemini Pro API.")
